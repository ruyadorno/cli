...
const ls = async (args) => {
  ...
  */
  ...
  // TODO: properly associate args and inventory.query
  if (args.length && !arb.inventory.values().size) process.exitCode = 1
...
function filterByEnv (data) {
  const inList = (list, value) => list.indexOf(value) !== -1
